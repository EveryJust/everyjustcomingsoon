  ...
  const categories = [
    {
      ...
      links: ['Car Seats', 'Fuel', 'Gearbox', 'Steering Parts']
    },
    {
      id: 2,
      title: 'Ferrari Wheel',
      image: '/promo_top_banner.png', // Placeholder
      links: ['Alloy Wheels', 'Forged Wheels', 'Retro Polka', 'Steel Wheels']
    },
    {
      id: 3,
      title: 'Gear oil',
      image: '/turbo_charger.png', // Placeholder
      links: ['Airbag Sensors', 'Coolant Sensors', 'Proximity sensor', 'Suspension']
    },
    {
      id: 4,
      title: 'Headlights',
      image: '/dash_camera.png', // Placeholder
      links: ['Bumpers', 'Dash Cam', 'Grills', 'Headlight']
    },
    {
      id: 5,
      title: 'Engine Oil',
      image: '/promo_bottom_banner.png', // Placeholder
      links: ['Brake Parts', 'Engine', 'Spark Plug', 'Transmission']
    },
    {
      id: 6,
      title: 'Wheels & Tires',
      image: '/promo_top_banner.png', // Placeholder
      links: ['Ammeter', 'Caliper', 'Clinometer', 'Dynamometer']
    }
  ];

  return (
    <div className="py-16 mt-16 relative overflow-hidden bg-gray-50/80 -mx-6 px-6 lg:-mx-12 lg:px-12 rounded-lg">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((category) => (
            ...
            >
              {/* Image Section */}
              <div className="w-1/3 flex-shrink-0 aspect-square relative flex items-center justify-center">
